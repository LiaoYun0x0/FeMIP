...
class RotateSpaceNetDataset(Dataset):
...
def build_Rotate_SpaceNet(
        train_data_file,
        test_data_file,
        size,
        stride):
    train_data = RotateSpaceNetDataset(
        train_data_file,
        size=(320, 320),
        stride=8)
    test_data = RotateSpaceNetDataset(
        test_data_file,
        size=(320, 320),
        stride=8)
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(
        RotateRocketDataset("/home/ly/Documents/zkj/spacenet/se_train.txt",size=size),
        batch_size=4,
        shuffle=True,
        num_workers=0,
        pin_memory=True)
